...
class RoyalController extends \GeorgRinger\News\Controller\NewsController
{
    ...
    public function listAction(array $overwriteDemand = null): ResponseInterface
    {
        ...
        if (version_compare(TYPO3_branch, '9.0', '>')) {
            $extpath = \TYPO3\CMS\Core\Utility\PathUtility::stripPathSitePrefix(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($this->extKey));
        } else {
        ...
        $GLOBALS['TSFE']->additionalHeaderData[$this->extKey . 'CSS1'] = '<link rel="stylesheet" type="text/css" href="' . $extpath . 'Resources/Public/slider/Royal-Slider/css/style.css" />';
        $GLOBALS['TSFE']->additionalHeaderData[$this->extKey . 'CSS2'] = '<link rel="stylesheet" type="text/css" href="' . $extpath . 'Resources/Public/slider/Royal-Slider/css/vendor/royalslider.css" />';
        $GLOBALS['TSFE']->additionalHeaderData[$this->extKey . 'CSS3'] = '<link rel="stylesheet" type="text/css" href="' . $extpath . 'Resources/Public/slider/Royal-Slider/css/vendor/skins/minimal-white/rs-minimal-white.css" />';

        // set js value for slider
        $constant = $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_nsnewsslider_royalslider.']['settings.'];
        $extvendorjspath = $extpath . 'Resources/Public/slider/Royal-Slider/js/vendor/';
        if ($constant['jQuery']) {
